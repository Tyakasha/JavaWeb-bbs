...
<div style="width: 100%;height: 1300px;background: #e9ecef;display: block">
    ...
    <header style="background: #fafafa;height: 67px;display: flex">
        <div class="label-website-name" >
            <label style="margin-left: 25px;cursor: pointer" id="returnHome">NCU校园技术论坛</label>
        </div>
    ...
    <div class="tag-area">
        ...
        <c:if test="${type=='1'}">
            <input type="text" placeholder="请设置该问题的积分奖励" class="form-control" style="width: 100%;height: 100%" id="reward">
        </c:if>
    </div>
    <%--进度旋转条--%>
